...
int main(){
    sf::RenderWindow window(sf::VideoMode(sf::Vector2u(400, 400)), "Cohen-Sutherland Clip");

    Line original(200, 200, 300, 400);
    cout << "Before: " << endl;
    original.display();
    ...
    sf::Vertex originalLine[] = {
        { sf::Vector2f(static_cast<float>(original.x1), static_cast<float>(original.y1)), sf::Color::Red },
        { sf::Vector2f(static_cast<float>(original.x2), static_cast<float>(original.y2)), sf::Color::Red }
    };

    sf::Vertex clippedLine[] = {
        { sf::Vector2f(static_cast<float>(clipped.x1), static_cast<float>(clipped.y1)), sf::Color::Green },
        { sf::Vector2f(static_cast<float>(clipped.x2), static_cast<float>(clipped.y2)), sf::Color::Green }
    };
